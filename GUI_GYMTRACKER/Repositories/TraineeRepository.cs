...
public class TraineeRepository : iTraineeRep
{
    private readonly string connectionString = "Data Source=DESKTOP-OUICEDR\\SQLEXPRESS;Initial Catalog=GUI;Integrated Security=True;Trust Server Certificate=True";
                    ...
                    using (SqlDataReader reader = command.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            Trainee trainee1 = new Trainee
                            {
                                ...
                                AppointmentDate = reader.GetString(4)
                            };
